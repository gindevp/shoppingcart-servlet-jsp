...
public class PageInfo {
	public static Map<PageType, PageInfo> router = new HashedMap();
	...
	static {
		...
		router.put(PageType.SITE_FORGOT_PASSWORD_PAGE,
				new PageInfo("Forgot Password", "/sites/users/forgot_password.jsp", null));
		...
		router.put(PageType.SITE_SHARE_PAGE, new PageInfo("Share", "/sites/videos/share_video.jsp", null));
